...
--
-- Host: 127.0.0.1
-- Generation Time: May 27, 2022 at 02:48 AM
...
(5, 'Brian Mohamad Safiudin', 'Kediri', 'L', '082114903130'),
(6, 'Dandy Wahyu Syahputra', 'Jombang', 'L', '081456021693'),
(7, 'Naufal Falah Wafiuddin', 'Tuban', 'L', '082140094494'),
(8, 'Rio Ardiyansyah', 'Lumajang', 'L', '087859937510'),
(9, 'Tri Jagad Ariyani', 'Tuban', 'P', '083833399182');
...
(3, 'Destination: Jakarta 2040', 2, 'Novel sci-fi yang satu ini berasal dari dalam negeri dan akan mengajak kamu loncat ke Jakarta di tahun 2040. Mengisahkan tentang Ilyas yang belajar tentang alam semesta dan bagaimana cara menciptakan manipulasi waktu.', 267, '9786230402265_Destination_Jakarta_2040_Depan.jpg'),
(7, 'Dasar Penguasaan Pemrograman', 10, 'Pemrograman java script untuk aplikasi berbasis website', 148, '15996662264_4088cd1e53_o.png');
...
(15, 3, 5, '2022-05-24', '2022-05-31'),
(17, 7, 6, '2022-05-21', '2022-05-28');
...
--
ALTER TABLE `anggota`
  MODIFY `anggota_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `kembali`
  MODIFY `kembali_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
